 ...
 *
 * @returns {Object} the finalized configuration for the current project.
 */
module.exports = function getConfigForProject() {
  if (_config) return _config

  const projectConfigPath = path.join(process.cwd(), 'ta-config.js')
  ...
  _config = Object.assign({}, require('../assets/default-config'), projectConfiguration)
  return _config
}
